...
/*
2. import java.io.*: 
- This means all the classes of io package can be imported. Java io package provides 
  a set of input and output streams for reading and writing data to files or other input or output sources.
...
8. println():  This method in Java is also used to display text on the console.
